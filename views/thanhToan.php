                            ...
                            <div class="billing-form-wrap">
                                <form action="#">
                                    ...
                                    <div class="single-input-item">
                                        ...
                                        <input type="text" id="sdt_nguoi_nhan" name="so_dien_thoai" value="<?= $user['so_dien_thoai'] ?>" placeholder="Số Điện Thoại" />
                                    </div>

                                    <div class="single-input-item">
                                        <label for="dia_chi_nguoi_nhan">Địa Chỉ Người Nhận</label>
                                        <input type="text" id="dia_chi_nguoi_nhan" name="dia_chi" value="<?= $user['dia_chi'] ?>" placeholder="Địa Chỉ Người Nhận" />
                                    </div>
