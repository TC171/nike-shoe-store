                            ...
                            <div class="card-body">
                                <div class="form-group">    
                                    ...
                                    <input type="text" class="form-control" name="ten_nguoi_nhan"
                                        placeholder="Nhập tên người nhận" value="<?= $donHang['ten_nguoi_nhan'] ?>">
                                 ...
                                 <div class="form-group">    
                                    ...
                                    <input type="text" class="form-control" name="sdt_nguoi_nhan"
                                        placeholder="Nhập tên người nhận" value="<?= $donHang['sdt_nguoi_nhan'] ?>">
                                ...
                                <div class="form-group">    
                                    ...
                                    <input type="email" class="form-control" name="email_nguoi_nhan"
                                        placeholder="Nhập tên người nhận" value="<?= $donHang['email_nguoi_nhan'] ?>">
                                ...
                                <div class="form-group">    
                                    ...
                                    <input type="text" class="form-control" name="dia_chi_nguoi_nhan"
                                        placeholder="Nhập tên người nhận" value="<?= $donHang['dia_chi_nguoi_nhan'] ?>">
                                ...
                                <div class="form-group">
                                    <label>Ghi chú</label>
                                    <textarea name="ghi_chu" class="form-control" id="" placeholder="Nhập Mô Tả"><?= $donHang[  'ghi_chu'] ?>
                                    </textarea>
                                    <hr>
